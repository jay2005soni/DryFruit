  ...
  return (
    <div>
      ...
      <div className="w-full h-min-screen mx-auto bg-gradient-to-r from-blue-600 to-blue-800 flex min-h-screen">
        <div className="w-full  bg-neutral-900 text-white flex flex-col lg:items-end justify-center lg:rounded-l-xs rounded-4xl sm:mx-18 mx-8 my-15 lg:m-0">
          <div className="container px-2 bg-neutral-900  w-full mx-0 sm:py-32 py-2 rounded-4xl">
            <div className="px-1 container mx-auto">
              <div className="mx-10 w-102 h-42 rounded-md pt-4 bg-red-100">
