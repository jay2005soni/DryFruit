...
import almondImage from "../assets/almon.png";
import mamroImage from "../assets/mamro.png";
import cashewImage from "../assets/cashews.png";

// Sample product data
const products = [
  {
    id: 1,
    title: "Premium Jumbo Almond",
  ...
  {
    id: 2,
    title: "Mamra Almond (Organic Almond)",
    imageUrl: mamroImage,
    weights: ["100 gram", "250 gram", "500 gram"],
    price: 380,
  },
  {
    id: 3,
    title: "Cashew Nuts (Kaju) Jumbo Sized",
